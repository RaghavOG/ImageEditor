...
class Panel(ctk.CTkFrame):
    def __init__(self,parent):
        ...
        self.pack(fill = 'x',pady = 10,ipady = 8,padx = 10)
...
class SliderPanel(Panel):
    ...
    def update_text(self,value,*args):
...
class SegmentedPanel(Panel):
    ...
    def __init__(self,parent,text,data_var,options):
        ...
        ctk.CTkSegmentedButton(self,variable=data_var,values=options).pack(expand = True,
                                                         pady=4,
                                                         fill = 'both',
                                                         padx = 4)
...
class FileNamePanel(Panel):
    def __init__(self,parent,name_string,file_string):
        ...
        jpg_check = ctk.CTkCheckBox(frame,text='jpg',variable=self.file_string,onvalue='jpg',offvalue='png' , command= lambda: self.click('jpg'))
        png_check = ctk.CTkCheckBox(frame,text='png',variable=self.file_string,onvalue='png',offvalue='jpg' , command= lambda: self.click('png'))
