...
class App(ctk.CTk):
    ...
    def init_parameters(self):
        ...
        self.color_vars = {
            ...
            'contrast' : ctk.DoubleVar (value = SHARPNESS_DEFAULT)
        }
    ...
    def manipulate_image(self,*args):
        ...
        if self.color_vars['sharpness'].get() != SHARPNESS_DEFAULT:
            sharpness_enhancer = ImageEnhance.Sharpness(self.image)
            self.image = sharpness_enhancer.enhance(self.color_vars['sharpness'].get())
        ...
        # grayscale and invert of the cold
